          ...
          <div className="space-y-8 animate-[slide-up_0.8s_ease-out]">
            <div className="space-y-6">
              ...
              <h1 className="font-bold text-5xl md:text-6xl lg:text-7xl leading-tight tracking-tight">
                Conquer the <span className="gradient-text">Himalayas</span> with Advensa Travels
              </h1>

              <p className="max-w-2xl text-muted-foreground text-xl leading-relaxed">
                Experience the breathtaking beauty of Nepal&apos;s mountain ranges. From Everest Base Camp to Annapurna
                Circuit, we guide you through the world&apos;s most spectacular trekking destinations.
              </p>
            </div>
